...
export default function Pool({
  ...
  useEffect(() => {
    masterChef
      ...
      .then(([amount, rewardDebt]: [BigNumber, BigNumber]) => {
        setUserInfo({
          amount,
          rewardDebt,
        });
  ...
  useEffect(() => {
    masterChef
      .pendingSushi(poolId, account)
      .then((_pendingSushi: BigNumber) => {
              ...
              <div className="level-item has-text-centered mr-5 pr-5">
                <div>
                  ...
                  <p className="title is-4">
                    {userInfo?.amount &&
                      ethers.utils.formatEther(userInfo?.amount)?.toString()}
                  </p>
                </div>
              </div>
              <div className="level-item has-text-centered mr-5 pr-5">
                <div>
                  ...
                  <p className="title is-4">
                    {poolInfo?.allocPoint &&
                      ethers.utils
                        .formatEther(poolInfo?.allocPoint)
                        ?.toString()}{" "}
                    DOGG
                  </p>
                </div>
            ...
            <div className="column">
              <div className="form container p-2">
                <div className="field is-flex is-align-items-center">
                  <p
                    className="control has-icons-left has-icons-right mr-2"
                    style={{ width: "300px" }}
                  >
                    <TokenInput
                      className="input"
                    ...
                    <span className="icon is-small is-left">DE</span>
                  </p>
                  <button
              ...
              <div className="has-text-left ml-3">
                ...
                >
                  {" "}
                  {lpBalance &&
                    ethers.utils.formatEther(lpBalance)?.toString()}{" "}
                  SLP-{getLabelToken(poolId)}{" "}
                </h3>
              </div>
            </div>
            <div className="column ">
              <div className="form container p-2">
                <div className="field is-flex is-align-items-center">
                  <p
                    className="control has-icons-left mr-2"
                    style={{ width: "300px" }}
                  >
                    ...
                    <span className="icon is-small is-left">WI</span>
                  </p>
                  <button
                    onClick={withdraw}
                    className="button is-primary is-light"
              ...
              <div className="has-text-left ml-3">
                ...
                <h3
                  onClick={() => {
                    setWithdrawValue(userInfo?.amount);
                  }}
                  className="title is-5"
                >
                  {" "}
            ...
            <div className="column has-background-success-light">
              <div className="has-text-centered pl-5">
                ...
                <h3 className="title is-5">
                  {" "}
                  {pendingSushi &&
                    ethers.utils.formatEther(pendingSushi)?.toString()}{" "}
                  DOGG{" "}
                </h3>
                <button onClick={claim} className="button is-success">
                  Claim rewards
                </button>
              </div>
            </div>
